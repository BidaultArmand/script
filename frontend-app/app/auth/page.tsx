      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-[3rem] p-8 md:p-12 border-4 border-black shadow-[8px_8px_0_rgba(0,0,0,1)]">
          ...
          <div className="flex items-center justify-center mb-8">
            <img src="/logo.svg" alt="echoCap" className="h-24 w-auto" />
          </div>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white font-black font-sans">OR</span>
            </div>
          </div>
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-4 text-lg font-bold rounded-full bg-white text-black border-4 border-black hover:scale-105 active:scale-95 transition-all shadow-[6px_6px_0_rgba(0,0,0,1)] hover:shadow-[8px_8px_0_rgba(0,0,0,1)] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
          >
